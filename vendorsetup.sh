...
mkdir -p out/target/product/treltexx/obj/KERNEL_OBJ/drivers/media/platform/exynos/fimc-is/sensor
mkdir -p out/target/product/treltexx/obj/KERNEL_OBJ/security/tima_uevent
